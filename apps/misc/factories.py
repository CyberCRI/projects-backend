...
class WikipediaTagFactory(factory.django.DjangoModelFactory):
    ...
    description_fr = factory.Faker("pystr", min_chars=1, max_chars=50)
    description_en = factory.Faker("pystr", min_chars=1, max_chars=50)
    name = factory.Faker("pystr", min_chars=1, max_chars=50)
    description = factory.Faker("pystr", min_chars=1, max_chars=50)
