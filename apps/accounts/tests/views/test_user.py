...
class FilterSearchOrderUserTestCase(JwtAPITestCase):
    ...
    def setUpTestData(cls):
        ...
        SkillFactory(user=cls.user_a, tag=cls.tag_1, can_mentor=True)
        SkillFactory(user=cls.user_b, tag=cls.tag_2, can_mentor=True)
        SkillFactory(user=cls.user_c, tag=cls.tag_1, needs_mentor=True)
