    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="name of the category", max_length=100
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "review_description_en",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_fr",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_de",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_nl",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_et",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_ca",
                    models.TextField(blank=True, null=True),
                ),
                (
                    "review_description_es",
                    models.TextField(blank=True, null=True),
                ),
                (
        ...
        migrations.AddField(
            ...
            name="images",
            field=models.ManyToManyField(
                related_name="templates", to="files.image"
            ),
        ),
        migrations.AddField(
            model_name="template",
