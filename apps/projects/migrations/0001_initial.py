    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purpose",
                    models.TextField(blank=True, verbose_name="main goal"),
                ),
                ...
                (
                    "duplicated_from",
                    models.CharField(
                        blank=True, default=None, max_length=8, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purpose_en",
                    models.TextField(
                        blank=True, null=True, verbose_name="main goal"
                    ),
                ),
                (
                    "purpose_fr",
                ...
                (
                    "groups",
                    models.ManyToManyField(
                        related_name="projects", to="auth.group"
                    ),
                ),
                (
                    "header_image",
                ...
                (
                    "images",
                    models.ManyToManyField(
                        related_name="projects", to="files.image"
                    ),
                ),
                (
                    "organizations",
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "HistoricalProject_tags"},
        ),
        migrations.CreateModel(
            ...
            options={"verbose_name": "HistoricalProject_categories"},
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={"unique_together": {("project", "target")}},
        ),
    ]
