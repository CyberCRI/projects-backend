# Generated by Django 4.2.25 on 2025-11-19 14:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title_nl", models.TextField(blank=True, null=True)),
                ("title_et", models.TextField(blank=True, null=True)),
                ("title_ca", models.TextField(blank=True, null=True)),
            ...
            bases=(services.translator.mixins.HasAutoTranslatedFields, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="crisalid.document"
            ),
        ),
        migrations.AddField(
            model_name="documentcontributor",
        ...
        migrations.AddConstraint(
            model_name="documentcontributor",
            constraint=models.UniqueConstraint(
                fields=("document", "researcher"), name="unique_researcher_document"
            ),
        ),
        migrations.AddConstraint(
            model_name="document",
