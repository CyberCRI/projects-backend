...
class ReviewTranslatedFieldsTestCase(JwtAPITestCase):
    ...
    def test_create_review(self):
        ...
        self.assertEqual(
            auto_translated_fields.count(), len(Review._auto_translated_fields)
        )
        self.assertSetEqual(
            {field.field_name for field in auto_translated_fields},
            set(Review._auto_translated_fields),
        )
    ...
    def test_update_review(self):
        ...
        payload = {
            ...
            for translated_field in Review._auto_translated_fields
        }
