...
class Command(BaseCommand):
            ...
            for keycloak_id in users_in_projects:
                try:
                    ...
                    if user:
                        ...
                        send_email(
                            subject, text, [user.email], html_content=html
                        )
    ...
    def handle_mood_users_to_create(self):
        ...
        people_groups = [
            people_group.get_members() for people_group in people_groups
        ]
        ...
        with open(f"{self.DIR}/mood_users_to_create_results.csv", "w") as file:
            for user_data in mood_users_to_create:
                try:
                    ...
                    link = (
                        KeycloakService.format_execute_action_link_for_template(
