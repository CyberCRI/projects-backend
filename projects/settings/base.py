...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        "accounts.ProjectUser": "fa-solid fa-user",
        "accounts.PeopleGroup": "fa-solid fa-users",
        "auth.Group": "fa-solid fa-users-gear",
        "auth.Permission": "fa-solid fa-key",
        "crisalid.CrisalidConfig": "fa-solid fa-cogs",
        "crisalid.Document": "fa-solid fa-file-lines",
        "crisalid.Identifier": "fa-solid fa-id-badge",
        "crisalid.Researcher": "fa-solid fa-user-tie",
        "deploys.PostDeployProcess": "fa-solid fa-bars-progress",
        "emailing.Email": "fa-solid fa-envelope",
        "files.Image": "fa-solid fa-image",
        "files.ProjectUserAttachmentFile": "fa-solid fa-paperclip",
        "files.ProjectUserAttachmentLink": "fa-solid fa-link",
        "google.GoogleAccount": "fa-brands fa-google",
        "google.GoogleGroup": "fa-solid fa-group-arrows-rotate",
        "google.GoogleSyncErrors": "fa-solid fa-triangle-exclamation",
        "keycloak.IdentityProvider": "fa-solid fa-shield-halved",
        "keycloak.KeycloakAccount": "fa-solid fa-id-card",
        "mistral.DocumentEmbedding": "fa-solid fa-bezier-curve",
        "mistral.EmbeddingError": "fa-solid fa-triangle-exclamation",
        "mistral.ProjectEmbedding": "fa-solid fa-bezier-curve",
        "mistral.UserEmbedding": "fa-solid fa-bezier-curve",
        "mixpanel.MixpanelEvent": "fa-solid fa-eye",
        "notifications.Notification": "fa-solid fa-bell",
        "organizations.Organization": "fa-solid fa-building",
        "organizations.ProjectCategory": "fa-solid fa-tags",
        "organizations.Template": "fa-solid fa-clone",
        "projects.BlogEntry": "fa-solid fa-rss",
        "projects.Project": "fa-solid fa-diagram-project",
        "skills.Skill": "fa-solid fa-lightbulb",
        "skills.TagClassification": "fa-solid fa-folder",
        "skills.Tag": "fa-solid fa-tag",
    },
}
JAZZMIN_UI_TWEAKS = {
