...
CELERY_CRISALID_BROKER_URL = f"amqp://{CRISALID_BUS['user']}:{CRISALID_BUS['password']}@{CRISALID_BUS['host']}:{CRISALID_BUS['port']}//"
CELERY_CRISALID_WORKER_SEND_TASK_EVENTS = True
CELERY_CRISALID_TASK_SEND_SENT_EVENT = True
CELERY_CRISALID_RESULT_BACKEND = os.getenv(
    "CELERY_RESULT_BACKEND", "redis://redis:6379/0"
)
CELERY_CRISALID_TIMEZONE = TIME_ZONE
CELERY_CRISALID_TASK_TRACK_STARTED = True
CELERY_CRISALID_BROKER_CONNECTION_RETRY_ON_STARTUP = True
